...
const Contact = () => {
    return (
        <div className='bg-alt w-full flex justify-center p-7'>
            ...
            <p className='text-center text-sm text-primary opacity-100 font-light mt-5'>Whether your'e a brand or an influencer, please get in touch, we'd love to work together.</p>
