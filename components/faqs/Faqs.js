...
const Faqs = () => {
    return (
        ...
        <h1 className='text-2xl flex justify-center font-base uppercase h-min pb-3 pt-5'>FAQS</h1>
        <div className='w-20 flex justfiy-center h-0.5 rounded bg-gray-300 m-auto mt-0 pt-0'></div>

        <p className='text-center text-sm text-primary opacity-100 font-light mt-5 md:w-[730px]'>We’ve put together some helpful tips for influencers...</p>
...
match your audience and sponsorship requirements. You
can choose to become exclusive at any time.
</p>
</div>
</div>
...
this for you. You’ll also be assigned your own RBI email address 
and we would handle all of your email enquires on your behalf.
</p>
</div>
</div>
...
collaboration. Once received from the client, you’ll be notified 
that your payment is being processed and from there it’ll take
1-3 days to show in your bank account. We normally send 
payments via bank account but we can accomodate PayPal
or Wise payments if preferred.
</p>
</div>
</div>
...
content creation. All sponsorships must be approved 
before publish. Send your sponsorship in for review to us 
no later than 48 business hours prior to your proposed live
date. You’ll be provided with a sponsorship deadline,
always ensure you meet this to avoid campaign 
cancellations.
</p>
</div>
</div>
