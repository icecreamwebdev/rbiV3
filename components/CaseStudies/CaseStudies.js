...
{/* <InstagramEmbed /> */}
    ...
    <div className='md:w-3/5 h-[500px] flex flex-col items-center justify-center text-white p-10 py-2 md:py-10  bg-primary overflow-hidden'>
