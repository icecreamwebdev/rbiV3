...
const TestoItem = ({brand='Surfshark', author='Test', mainText='blablab friv rvhfv reivh rfvre ovrevf regf rewgfverw0 gver', image,  imgSrc}) => {
    return (
        <div className=' text-center m-4 flex-col items-center justify-between'>
           ...
           <div className='w-16 h-16 md:w-20 md:h-20 absolute mt-[-110px] md:mt-[-125px] ml-[10px]  p-2 z-10 rounded-xl md:rounded-3xl bg-primary border-4 border-gray-200'><Image  src={`/${image}`} width='100' height='100' objectFit='contain' /></div>
