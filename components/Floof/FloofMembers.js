...
const FloofMembers = () => {
    ...
    return (
        ...
        <div className='flex flex-col md:flex-row  w-full  mt-10 justify-between items-center text-white'>
            ...
            <Image src='/paw.png' width='70' height='70' objectFit='contain' />
...
<h2 className='text-lg flex justify-center lg:mt-20 mt-10 pb-2 font-base uppercase h-min  pt-5 text-alt '>RBI FLoofs</h2>
